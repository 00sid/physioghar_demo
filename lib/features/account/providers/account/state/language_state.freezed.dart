...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( LanguageEnum language)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( LanguageEnum language)  $default,) {final _that = this;
switch (_that) {
case _LanguageState():
return $default(_that.language);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( LanguageEnum language)?  $default,) {final _that = this;
switch (_that) {
case _LanguageState() when $default != null:
return $default(_that.language);case _:
  return null;
...
class _LanguageState implements LanguageState {
   _LanguageState({this.language = LanguageEnum.english});
